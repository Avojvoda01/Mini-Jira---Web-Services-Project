        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-6 text-muted-foreground">
              System-wide configuration and administration tools. More options will be added here.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-2 lg:mx-4">
        <Card className="border-border/70 bg-card/80 shadow-sm backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>Admin settings and system configuration will be available here.</CardDescription>
          </CardHeader>
        </Card>
      </div>
    </section>
