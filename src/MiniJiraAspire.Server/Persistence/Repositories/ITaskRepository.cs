...
{
    Task<List<TaskItem>> GetAllAsync(string? search, string? status, string? priority, string? assigneeId, string? epicId, CancellationToken cancellationToken = default);
