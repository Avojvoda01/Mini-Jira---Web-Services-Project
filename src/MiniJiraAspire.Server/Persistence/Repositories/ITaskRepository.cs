...
public interface ITaskRepository
{
    ...
    Task<TaskItem?> ChangeStatusAsync(Guid id, string status, CancellationToken cancellationToken = default);
    Task<TaskItem?> ChangePriorityAsync(Guid id, string priority, CancellationToken cancellationToken = default);
    Task<TaskItem?> AssignUserAsync(Guid id, Guid? userId, CancellationToken cancellationToken = default);
    Task<TaskItem?> AssignEpicAsync(Guid id, Guid? epicId, CancellationToken cancellationToken = default);
}
