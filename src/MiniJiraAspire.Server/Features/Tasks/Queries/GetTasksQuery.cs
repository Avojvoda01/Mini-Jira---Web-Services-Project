...
public class GetTasksHandler(ITaskRepository repository) : IRequestHandler<GetTasksQuery, TaskItemDto[]>
{
    public async Task<TaskItemDto[]> Handle(GetTasksQuery request, CancellationToken ct)
    {
        ...
        return tasks.Select(t => new TaskItemDto(t.Id, t.Title, t.Description, t.Status, t.Priority, t.ProjectId, t.AssigneeId, t.EpicId, t.CreatedById, t.UpdatedById, t.CreatedAtUtc, t.UpdatedAtUtc, t.EstimateMinutes)).ToArray();
    }
}
